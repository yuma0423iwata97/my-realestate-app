    ...
    <article className={["group relative flex flex-col md:flex-row bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1", className ?? ""].join(" ")}>
      ...
      <div className="flex-1 p-5 flex flex-col justify-between min-w-0">
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-y-3 gap-x-2 my-4 bg-gray-50 rounded-xl p-3 border border-gray-100">
             <div className="flex flex-col">
                <span className="text-[10px] text-gray-500 flex items-center gap-1"><Home size={10} /> 間取り</span>
                <span className="text-sm font-bold text-gray-800">{p.Layout || "-"}</span>
             </div>
             ...
             <div className="flex flex-col border-l-0 sm:border-l md:border-l-0 lg:border-l border-gray-200 pl-0 sm:pl-3 md:pl-0 lg:pl-3">
